...
| [04-experiment-card.md](04-experiment-card.md) | 每次运行正式实验前 | baseline 已稳定，问题、规模升级、重复运行、选择规则和停止条件明确 |
...
| [16-run-handoff.md](16-run-handoff.md) | 关键运行进入组会、迁移、暂停或交给他人复查时 | 接收者能从唯一入口按声明深度查找、核验、最小复跑或接管 |
