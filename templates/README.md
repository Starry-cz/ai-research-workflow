...
| [05-weekly-review.md](05-weekly-review.md) | 每周、组会或阶段结束时 | 关键反馈已确认语义并转成处理决定、行动、验证和关闭 / 重开状态 |
...
| [10-debug-help-request.md](10-debug-help-request.md) | 环境、代码、数据或研究流程卡住，准备求助、提上游 Issue 或贡献时 | 问题所有者、支持范围、最小复现、正确渠道、公开边界和路由状态明确 |
...
| [15-result-claim-audit.md](15-result-claim-audit.md) | 实验完成后、准备组会、共享结果、项目决策、制作图表或写结论前 | 结果完整，证据与共享等级分开判断，错误和反例已检查，主张不超过证据 |
