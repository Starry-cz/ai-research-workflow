...
- **经验对照**：
  - 知乎关于[计算机公开课资源](https://www.zhihu.com/question/38335108/answer/1993372768251687650)直接指出资源已经多到难以选择，核心问题是判断哪些值得投入；另一篇入门经验也概括了“收藏夹教程越多，越不知道从哪一块开始”的困惑。这些内容可能带有课程或服务推荐，本仓库只吸收“选择成本是真实阻塞”的观察；
...
- 审计 README 超过千行后的信息架构：判断哪些内容必须留在首屏与主流程，哪些应下沉到 `docs/`，同时保持 GitHub 单页入口和移动端可读性。
